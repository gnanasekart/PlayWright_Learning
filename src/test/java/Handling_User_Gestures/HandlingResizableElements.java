...
public class HandlingResizableElements extends BaseFunction {

    @Test
    public void TestSliders() throws InterruptedException {
        Page page = launchBrowserWithMaximize("chrome", "https://jqueryui.com/resources/demos/resizable/default.html");
